...
abstract class UnexpectedException
    implements
  ...
  factory UnexpectedException({
    required String message,
    String? stackTrace,
  }) = _UnexpectedExceptionImpl;

  factory UnexpectedException.fromJson(Map<String, dynamic> jsonSerialization) {
  ...
  /// Returns a shallow copy of this [UnexpectedException]
