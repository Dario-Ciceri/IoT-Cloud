...
CREATE TABLE "iot_device_state" (
    ...
    "errorMessage" text,
    "heartBeat" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "createdAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
--
-- Class PlatformioProject as table platformio_project
--
...
--
-- Class UrlMapping as table url_mapping
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('iot_cloud', '20250311161316607', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250311161316607', "timestamp" = now();
